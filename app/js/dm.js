...
function buildSystemPrompt(scenario, opts = {}) {
  ...
  return [
    ...
    '- KEEP THE MOMENTUM. A turn must NOT end as a flat dead end. The group acted; the world reacts AND moves on. End each response by introducing a NEW DEVELOPMENT: a fresh escalation, new information, a reaction from an actor/regulator/media, an event that complicates or sharpens the situation. Leave the group facing something concrete.',
